    ...
    <section class="home-section-1 d-flex align-items-end white-nav">
        <div class="container-fluid h-100 position-relative">
            ...
            ">
                ...
                <span class="sub-header my-1">Gulir untuk Jelajahi</span>
                <div style="
            ...
            <div class="row mt-auto mt-md-0 mb-md-5 align-items-end">
                <div class="col-12 col-md-6">
                    <h1 class="mb-4">Sumber Energi <br>
                ...
                <div class="col-12 col-md-4">
                    <p>
                        Untuk membangun masa depan yang berkelanjutan, Reethau menawarkan energi bersih untuk semua
                        kebutuhan. Upaya penggunaan energi bersih dapat memberikan kepercayaan, keandalan dan keluaran
                ...
                <div class="col-12 order-md-4 order-1">
                    ...
                    <div class="d-flex align-items-end justify-content-between">
                        <h1 class="mb-5 mb-md-0">
                            Membentuk <b> masa depan</b> <br class="d-md-none"> yang <br class="d-none d-md-block">
                            lebih <b> bersih <br class="d-md-none"> </b> dengan <b> gas alam</b>
                        </h1>
                        <a href="/tentang" class="learn-more-btn d-none d-md-flex">
                            <span class="d-none d-md-flex">Pelajari lebih lanjut</span>
                            <span class="d-flex d-md-none">Telusuri</span>
        ...
        <div class="container-fluid mobile-padding-0 h-100 my-5 flex-column">
            ...
            <div class="content justify-content-center align-items-center p-0 d-md-none lng" id="lng">
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        <img src="<?= get_template_directory_uri() . '/assets/images/lng-1.webp' ?>" alt="lng-tabung"
                            class="w-100">
                    </div>
                </div>
            </div>
            ...
            <div class="scrollable-section mobile-padding-1 mt-5 mt-md-0">
                ...
                <div class="content active justify-content-center align-items-center cng" id="cng">
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <span class="green d-none d-md-block">Produk Energi Bersih</span>
                            ...
                            <p>
                                Kami berupaya membangun masa depan yang berkelanjutan <br class="d-none d-md-block">
                                dengan melakukan hal yang benar, yaitu melindungi alam <br class="d-none d-md-block">
                                dengan penggunaan energi bersih sebagai bahan bakar yang <br class="d-none d-md-block">
                                ramah terhadap lingkungan.
                            </p>
                            <div class="mt-auto">
                                <a href="/produk" class="learn-more-btn">
                                    <span class="d-none d-md-flex">Pelajari lebih lanjut</span>
                                    <span class="d-flex d-md-none">Telusuri</span>
                        ...
                        <div class="col-12 col-md-6">
                            <img src="http://reethau.com/wp-content/uploads/2023/12/home-carousel-1.webp"
                                alt="checking-pipe" class="w-100 d-none d-md-block">
                ...
                <div class="content justify-content-center align-items-center biomassa" id="biomassa">
                    <div class="row">
                        <div class="col-12 col-md-6">
                            ...
                            <p>
                                Kami mengolah biomassa berupa kayu yang diperoleh dari <br class="d-none d-md-block">
                                sumber yang terpercaya dan profesional untuk dapat <br class="d-none d-md-block">
                ...
                <div class="content justify-content-center align-items-center lng" id="lng">
                    <div class="row">
                        <div class="col-12 col-md-6">
                            ...
                            <p>
                                Meningkatnya penggunaan gas alam cair membawa kami untuk <br class="d-none d-md-block">
                                ikut berkontribusi pada lingkungan yang lebih bersih dengan <br
                                    class="d-none d-md-block">
                                menawarkan LNG sebagai inovasi pada pilihan bahan bakar.
                            </p>
                            <div class="mt-auto">
                                <a href="/produk" class="learn-more-btn">
                                    <span class="d-none d-md-flex">Pelajari lebih lanjut</span>
                        ...
                        <div class="col-12 col-md-6 d-none d-md-block">
                            <img src="<?= get_template_directory_uri() . '/assets/images/lng-1.webp' ?>"
                                alt="lng-tabung" class="w-100">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid mt-auto mt-md-0">
            <div class="row">
                <h1 class="text-center  z-index-3">
                    <span class="green-lt">Inovasi melalui</span> Teknologi, <br>
                    <span class="green-lt">memimpin melalui</span> Keberlanjutan.
                </h1>
            </div>
        </div>
